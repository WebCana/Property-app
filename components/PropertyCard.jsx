...
// at vid:'Property image display'(cloudinary),we removed this--> src= {`/images/properties/${property.images[0]}`}// we took first image from the array
  return (
      <div className="rounded-xl shadow-md relative bg-blue-200 mt-1 mb-1">
            <Image
              src= {property.images[0]}//now the property object is coming from cloudinary,, we took first image from the array
              alt=""
              height={0}
              width={0}
              sizes='100vw'
